  ...
  <div class="formcontain" v-loading="loading">
    <el-form :model="planform" :rules="rules" ref="ruleForm" label-width="160px">
      ...
      <el-form-item style="margin-top:10px;">
        <el-button type="primary" @click="onSubmit('leave')" :disabled="submitButton">保存</el-button>
      </el-form-item>
    </el-form>
  </div>
  <!-- 图片放大 -->
...
import { newsCategoryInfo, modifyNewsInfo, newsInfodetail } from '@/api/newsinfo'
export default {
  name: 'modifyNews',
  data() {
    ...
    onSubmit(type) {
      ...
      this.$refs['ruleForm'].validate((valid) =>{
        if(valid){
          ...
          this.loading=true
          modifyNewsInfo(this.planform).then(res=>{
            if(res.data.code=='success'){
              this.$message({
                message: '修改成功',
                type: 'success'
